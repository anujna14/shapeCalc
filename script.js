...
function goToStep2() {
  this.selectedShape = document.querySelector('input[name="shape"]:checked').value;
  document.getElementById("caltitle").innerHTML = "Step 2 : Insert your values";
  document.getElementById("caldesc").innerHTML = "You have selected a " + this.selectedShape + ", please input the required variables";
...
function goToStep3() {
  ...
  switch (this.shape) {
    ...
    case "circle":
      document.getElementById("caldesc").innerHTML =
        "You have calculated the area of a " + this.shape + " with a radius of " + this.circleRadius + ". Below is your result:";
      break;
    case "square":
      document.getElementById("caldesc").innerHTML =
        "You have calculated the area of a " + this.shape + " with a side of " + this.squareSide + ". Below is your result:";
      break;
    case "ellipse":
      document.getElementById("caldesc").innerHTML =
        "You have calculated the area of a " +
...
function assignValues() {
  ...
  console.log(this.rectangleLength, this.rectangleBreadth, this.circleRadius, this.squareSide, this.ellipseLongAxis, this.ellipseShortAxis);
}
